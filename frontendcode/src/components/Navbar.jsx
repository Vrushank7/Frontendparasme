...
function Navbar() {
  ...
  return (
    <div className="navbar-container" style={{ position: 'fixed',top: 0,left: 0,width: '100%',display: 'flex',justifyContent: 'space-between',
        ...
        <ul style={{ listStyle: 'none',display: 'flex',gap: '1.5rem',margin: 0,paddingRight: '1rem'}}>
          ...
          <li ref={productsRef} className="dropdown" style={{ position: 'relative', cursor: 'pointer' }} onClick={toggleProductsDropdown}>
            ...
            {showProductsDropdown && (
              <ul style={{ position: 'absolute',backgroundColor: 'white',boxShadow: '0 8px 16px rgba(0, 0, 0, 0.1)',padding: '1rem',
      ...
      {isMobileMenuOpen && (
        <div className="mobile-nav" style={{ display: 'none',position: 'fixed',top: '80px',left: 0,width: '100%',
          ...
          <ul style={{ listStyle: 'none',padding: 0,margin: 0,textAlign: 'center'}}>
            <li style={{ margin: '1rem 0' }}>
              <NavLink to="/" onClick={closeMobileMenu} style={({ isActive }) => ({textDecoration: 'none',color: isActive ? 'orangered' : 'black',
                fontSize: '1.1rem',padding: '0.5rem 0',borderBottom: isActive ? '2px solid orangered' : 'none',})}>Home</NavLink></li>
            <li style={{ margin: '1rem 0' }}>
              <NavLink to="/about" onClick={closeMobileMenu} style={({ isActive }) => ({textDecoration: 'none',color: isActive ? 'orangered' : 'black',
                fontSize: '1.1rem',padding: '0.5rem 0',borderBottom: isActive ? '2px solid orangered' : 'none',})}>About</NavLink>
            </li>
              ...
              {showProductsDropdown && (
                <ul style={{ listStyle: 'none', padding: '0 1rem', margin: '0.5rem 0' }}>
                  <li style={{ margin: '0.5rem 0' }}>
                    <NavLink to="/products/database"  onClick={closeMobileMenu} style={({ isActive }) => ({textDecoration: 'none',color: isActive ? 'orangered' : 'black',
                      fontSize: '1.1rem',borderBottom: isActive ? '2px solid orangered' : 'none',})}>Database</NavLink>
                  </li>
                  <li style={{ margin: '0.5rem 0' }}>
                    <NavLink to="/products/middleware" onClick={closeMobileMenu} style={({ isActive }) => ({textDecoration: 'none',
                      color: isActive ? 'orangered' : 'black',fontSize: '1.1rem',borderBottom: isActive ? '2px solid orangered' : 'none',})}>Middleware</NavLink>
                  </li>
                  <li style={{ margin: '0.5rem 0' }}>
                    <NavLink to="/products/server" onClick={closeMobileMenu} style={({ isActive }) => ({ textDecoration: 'none',color: isActive ? 'orangered' : 'black',
                      fontSize: '1.1rem',borderBottom: isActive ? '2px solid orangered' : 'none',})}>Server</NavLink>
                  </li>
                </ul>
              )}
            </li>
            <li ref={solutionsRef} style={{ margin: '1rem 0' }}>
              ...
              {showSolutionsDropdown && (
                <ul style={{ listStyle: 'none', padding: '0 1rem', margin: '0.5rem 0' }}>
                  <li style={{ margin: '0.5rem 0' }}>
                    <NavLink to="/solutions/automation" onClick={closeMobileMenu} style={({ isActive }) => ({ textDecoration: 'none',
                      color: isActive ? 'orangered' : 'black',fontSize: '1.1rem',borderBottom: isActive ? '2px solid orangered' : 'none',})}>Automation</NavLink>
                  </li>
                  <li style={{ margin: '0.5rem 0' }}>
                    <NavLink to="/solutions/solution-engineering" onClick={closeMobileMenu} style={({ isActive }) => ({ textDecoration: 'none',
                      color: isActive ? 'orangered' : 'black',fontSize: '1.1rem',borderBottom: isActive ? '2px solid orangered' : 'none',})}>Solution Engineering</NavLink>
                  </li>
                </ul>
              )}
            </li>
            <li style={{ margin: '1rem 0' }}>
              <a href="https://cal.com/parasme/30min?date=2024-07-12&month=2024-07"
                style={{ backgroundColor: 'orangered',color: 'white',padding: '0.5rem 1rem',
                  border: 'none',textDecoration: 'none',borderRadius: '5px',display: 'inline-block',fontSize: '1.1rem'}}>Book A Demo</a>
            </li>
          </ul>
        </div>
      )}
