...
function Database() {
  ...
  return (
    <main style={{ marginTop: "6rem", paddingTop: "6rem", backgroundColor: "#f3f5fb", backgroundImage: "linear-gradient(#fff2ec, #fff)" }}>
      ...
      <div style={{ marginBottom: "76px", paddingLeft: "2.5rem", paddingRight: "2.5rem" }}>
        <div style={{ width: "100%", maxWidth: "48rem", marginLeft: "auto", marginRight: "auto" }}>
          <div style={{ color: "black", textAlign: "center", fontFamily: "Poppins, sans-serif", fontSize: "1rem", fontStyle: "italic", fontWeight: "400", marginBottom: "-2rem" }}>
            <strong style={{ fontWeight: "500" }}>Browse Our Automation Packs</strong></div>
          <div style={{ paddingBottom: ".5rem" }}></div>
          <h1 style={{ fontSize: "3rem", fontWeight: "600", lineHeight: "1.2", color: "orangered", textAlign: "center" }}>Grow With Industry Leading Automation
          </h1>
          ...
          <div style={{ gridColumnGap: "16px",gridRowGap: "16px",border: "1px solid #f3f5fb",borderRadius: "12px",gridTemplateRows: "auto",gridTemplateColumns: "1.75fr .5fr 1.75fr .5fr 2fr",gridAutoColumns: "1fr",justifyContent: "center",alignItems: "center",padding: "40px 32px",display: "grid"}}>
            <div style={{ display: "grid", gridColumnGap: "16px", gridRowGap: "16px", placeItems: "center", gridTemplateRows: "auto auto",gridTemplateColumns: "1fr",gridAutoColumns: "1fr", }}>
              <div style={{backgroundColor: "orangered",textAlign: "center",borderRadius: "8px",justifyContent: "center",alignItems: "center",width: "37px",height: "37px",marginBottom: "32px",padding: "16px",display: "flex"}}>
                <img src={avail} loading="lazy" width="40" alt="" /></div>
              <div style={{ marginBottom: "8px" }}><div style={{ color: "black", textAlign: "center", fontSize: "24px", fontWeight: "700", lineHeight: "32px",letterSpacing: "-0.02em" }}>Availability</div></div>
              <p style={{ textAlign: "center", fontSize: "14px", letterSpacing: "-0.01em", marginBottom: "0", lineHeight: "1.8",color:"#666" }}>Host monitoring<br />Database monitoring<br />Tablespace management<br />Partition management<br />Statistics gathering<br />Housekeeping</p></div>
            ...
            <div style={{ display: "grid", gridColumnGap: "16px", gridRowGap: "16px", placeItems: "center" }}>
              <div style={{backgroundColor: "orangered",textAlign: "center",borderRadius: "8px",justifyContent: "center",alignItems: "center",width: "37px",height: "37px",marginBottom: "32px",padding: "16px",display: "flex"}}>
                <img src={prot} loading="lazy" width="40" alt="" /></div>
              <div style={{ marginBottom: "8px" }}>
                <div style={{ color: "black", textAlign: "center", fontSize: "24px", fontWeight: "700", lineHeight: "32px",letterSpacing: "-0.02em" }}>Protection</div></div>
              <p style={{ textAlign: "center", fontSize: "14px", letterSpacing: "-0.01em", lineHeight: "1.8", marginBottom: "0",color:"#666" }}>Database Backup<br />Standby Database Syncing<br />Account Unlocking<br />Password Reset<br />Disaster Recovery Drill<br />‍<br /></p></div>
            <div style={{ backgroundColor: "#f3f5fb", width: "1px", height: "200px", marginLeft: "40px", marginRight: "40px" }}></div>
            <div style={{ display: "grid", gridColumnGap: "16px", gridRowGap: "16px", textAlign: "center" }}>
              <div style={{backgroundColor: "orangered",textAlign: "center",borderRadius: "8px",justifyContent: "center",alignItems: "center",width: "37px",
                height: "37px",marginBottom: "32px",padding: "16px",display: "flex", marginLeft: "110px" }}>
              ...
              <p style={{ textAlign: "center", fontSize: "14px", lineHeight: "1.8",letterSpacing: "-0.01em",color:"#666"}}>Admin User Password Change<br />Keystore Password Change<br />License Audit<br />Transparent Data Encryption<br />‍<br /></p>
            </div>
          </div>
          <div style={{gridColumnGap: "16px",gridRowGap: "16px",border: "1px solid #f3f5fb",borderRadius: "12px",gridTemplateRows: "auto",gridTemplateColumns: "1.75fr .5fr 1.75fr",
            gridAutoColumns: "1fr",justifyContent: "center",alignItems: "center",padding: "40px 32px",display: "grid"}}>
            <div style={{ display: "grid", gridColumnGap: "16px", gridRowGap: "16px", placeItems: "center", gridTemplateRows: "auto auto",gridTemplateColumns: "1fr",gridAutoColumns: "1fr", }}>
              <div style={{backgroundColor: "orangered",textAlign: "center",borderRadius: "8px",justifyContent: "center",alignItems: "center",width: "37px",height: "37px",marginBottom: "32px",padding: "16px",display: "flex"}}>
                <img src={prov} loading="lazy" width="40" alt="" /></div>
              <div style={{ marginBottom: "8px" }}>
                <div style={{ color: "black", textAlign: "center", fontSize: "24px", fontWeight: "700", lineHeight: "32px",letterSpacing: "-0.02em" }}>Provisioning</div></div>
              <p style={{ textAlign: "center", fontSize: "14px", lineHeight: "1.8", marginBottom: "0",letterSpacing: "-0.01em",color:"#666" }}>RDBMS Installation<br />Database Provisioning<br />Quarterly CPU Patching<br />Database Upgrade<br />Database Refresh & Cloning<br />Custom SQL Execution</p></div>
            <div style={{ backgroundColor: "#f3f5fb", width: "1px", height: "200px", marginLeft: "40px", marginRight: "40px" }}></div>
            <div style={{ display: "grid", gridColumnGap: "16px", gridRowGap: "16px", placeItems: "center" }}>
              <div style={{backgroundColor: "orangered",textAlign: "center",borderRadius: "8px",justifyContent: "center",alignItems: "center",width: "37px",height: "37px",marginBottom: "32px",padding: "16px",display: "flex"}}>
                <img src={trou} loading="lazy" width="40" alt="" /></div>
              <div style={{ marginBottom: "8px" }}>
    ...
    <section style={{ padding: "4rem", marginBottom: "90px" }}>
      <div style={{ textAlign: "center", maxWidth: "48rem", margin: "auto" }}>
        ...
        <div style={{ textAlign: "center", paddingTop: "1rem", fontSize: "3rem", color: "orangered" }}>
          <a href="https://cal.com/parasme/30min?date=2024-07-12&month=2024-07" style={{ backgroundColor: hover ? "#FFB380" : "orangered",color: "white",padding: "1rem 3rem",borderRadius: ".6rem",textDecoration: "none",fontWeight: "600",transition: "background-color 0.3s ease",}}onMouseEnter={() => setHover(true)}onMouseLeave={() => setHover(false)}>Book A Demo</a>
        </div>
      </div>
    </section>
    <Footer />
